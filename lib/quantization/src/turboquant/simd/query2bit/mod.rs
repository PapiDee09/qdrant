...
pub fn score_2bit_internal(a: &[u8], b: &[u8]) -> f32 {
    ...
    match Backend::detect() {
        #[cfg(target_arch = "x86_64")]
        Backend::Avx512Vnni => unsafe { x64::score_2bit_internal_avx512_vnni(a, b) },
        #[cfg(target_arch = "x86_64")]
        Backend::Avx2 => unsafe { x64::score_2bit_internal_avx2(a, b) },
        #[cfg(target_arch = "x86_64")]
        Backend::Sse => unsafe { x64::score_2bit_internal_sse(a, b) },
        #[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
        Backend::NeonSdot => unsafe { arm::score_2bit_internal_neon_sdot(a, b) },
        #[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
        Backend::Neon => unsafe { arm::score_2bit_internal_neon(a, b) },
        Backend::Scalar => score_2bit_internal_scalar(a, b),
    }
}
...
pub fn score_2bit_internal_weighted(a: &[u8], b: &[u8], weights: &[i16]) -> i64 {
    ...
    match Backend::detect() {
        ...
        #[cfg(target_arch = "x86_64")]
        Backend::Sse => unsafe { x64::score_2bit_internal_weighted_sse(a, b, weights) },
        #[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
        Backend::NeonSdot | Backend::Neon => unsafe {
            arm::score_2bit_internal_weighted_neon(a, b, weights)
        },
        Backend::Scalar => score_2bit_internal_weighted_scalar(a, b, weights),
    }
}
